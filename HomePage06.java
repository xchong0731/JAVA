...
private String[] hotel_info= new String[]{"Contact information","Tel:(201)586-9124","Email:XXXhotle@gmail.com"};
public HomePage(){
	//Whole windows
	...
	label1.setFont(new Font("times", Font.BOLD,48));
	p1.add(label1);
	...
	p2.setOpaque(false);
	p2.setLayout(new FlowLayout(FlowLayout.CENTER,20,360));
	...
	ImageIcon mapPic= new ImageIcon();
	JLabel mapL=new JLabel(mapPic);
	JPanel map=new JPanel();
	map.add(mapL);
	JScrollPane subp1=new JScrollPane(map);
...
// hotel contact information panel
	...
	subp2.setLayout(new GridLayout(3,1,20,20));
